...
const prepareDir = path.join(__dirname, '/src/design-system/icon/prepare')
const assetDir = path.join(__dirname, '/src/design-system/icon/asset')

// [export 구문 생성] ./src/icon/default 디렉토리 내 icon파일 목록 업데이트
const directoryPath = path.join(__dirname, '/src/design-system/icon/default')
